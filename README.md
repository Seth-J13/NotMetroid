# NotMetroid
This is totally not a recreation of metroid. This has NotSam a character who has different powerups and a goal to gather all her power ups as quickly as possible.
...
- *RMB to fire rockets (ammo required)
- *C to go into morph ball
- *LMB (while crouched) to use morph bombs
